...
<head>
    ...
    <style>
        body {
            ...
            margin: 40px; /* Add margins to the body */
        }
        p {
            text-align: justify;
        }
        h1 {
            text-align: center; /* Center the text of the h1 element */
        }
    </style>
</head>
<body>
    ...
    <ul>
        <li>With your consent. We will share personal information with companies, organizations, or individuals outside of our company when we have your consent to do so.</li>
        <li>For legal reasons. We will share personal information with companies, organizations, or individuals outside of our company if we have a good-faith belief that access, use, preservation, or disclosure of the information is reasonably necessary to:</li>
        <ul>
            ...
            <li>Protect against harm to the rights, property, or safety of our company, our users, or the public as required or permitted by law.</li>
        </ul>
    </ul>
